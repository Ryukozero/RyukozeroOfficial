...
* (Scriptnya Nfq cuy).
*/
const BotName = 'Ryuko¥Zero_V2.1'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/p/CJBVosgFoQX/?igshid=j7iccgxayk7x'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/6282111586214'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung Ownernya'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/IvXvRp8CO3k22OdIaB1DhG'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://youtube.com/channel/UCSpCxHletf7IBrVYLDnMPLA'; // OFFICIAL YT LU
const grupch3 = 'https://chat.whatsapp.com/GLgEJCLSD6M2bOeyUsK6KN'; // OFFICIAL GRUP LU 3
//
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Ryuko¥Zero`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @ryukozero_official`)
})
